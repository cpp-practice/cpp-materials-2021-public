...
Оценка за активности: `activities = with_seminars ? AVG(домашние, контрольные, дорешки) : (домашние)`

Итоговая оценка: `with_exams ? MAX(activities, AVG(activities, exam)) : activities`
