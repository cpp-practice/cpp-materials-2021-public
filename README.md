...
#### LiveСoding (решения "у доски")

Во время семинаров мы будем просить вас решать задачи так, чтобы это видели остальные участники семинара. Этот навык очень пригодится вам на собеседованиях при поиске работы.
