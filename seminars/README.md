...
[Снятие бонусных баллов при текущей инфраструктуре предполагает очень много ручной работы, поэтому этот пункт не будет применяться при расчете оценки]
